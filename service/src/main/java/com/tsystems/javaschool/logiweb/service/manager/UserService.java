...
public interface UserService extends UserDetailsService {
     ...
     */
    int createNewUser(String userName, String pass, User.UserRole role) throws DuplicateKeyException, InvalidStateException;
     ...
     * @return user or null
     */
    User findUserById(int id) throws EntityNotFoundException;
}
