...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    @Override
    public int createNewUser(String userName, String pass, User.UserRole role) throws DuplicateKeyException, InvalidStateException {
    ...
    @Override
    @Transactional
    public User findUserById(int id) throws EntityNotFoundException {
