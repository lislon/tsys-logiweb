...
public class OrderManagerImplTest {
    ...
    public void createManager() {
        ...
        orderManager = new OrderManagerImpl(mockRepo, cargoRepo, waypointRepo, cityManager, driverManager, truckManager);
    }
    ...
    public void getRouteLength() throws Exception {
        ...
        int routeLength = orderManager.getRouteLength(route);
    ...
    public void getMaxPayload() throws Exception {
        ...
        int maxPayload = orderManager.getMaxPayload(list);
