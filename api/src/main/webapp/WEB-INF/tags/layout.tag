                ...
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="${pageContext.request.contextPath}/dist/img/courier.png" height="160" width="160" class="img-circle" alt="User Image">
                                            </div>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="${pageContext.request.contextPath}/dist/img/courier.png" height="160" width="160" class="user-image" alt="User Image">
