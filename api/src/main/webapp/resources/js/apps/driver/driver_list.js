...
var LIST_URL = CONTEXT_PATH + '/api/drivers';
var EDIT_URL = CONTEXT_PATH + '/api/drivers/';
var DELETE_URL = CONTEXT_PATH + '/api/drivers/';
...
function actionFormatter(value, row) {
    ...
    // ].join(' ');
    return [
        '<a class="update" href="' + CONTEXT_PATH + '/drivers/edit/' + row.id + '" title="Edit driver"><i class="glyphicon glyphicon-edit"></i></a>',
        '<a class="remove" href="javascript:" title="Delete Item"><i class="glyphicon glyphicon-remove-circle"></i></a>',
    ].join(' ');
}
